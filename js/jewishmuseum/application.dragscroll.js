...
(function() {
  var bindTooltips, createPagination, fixSelect, loadImg, moveRibbons, toggleHash;
  ...
  loadImg = function(els) {
    return els.each(function() {
      ...
      return t.not('.loaded').addClass('loaded').attr('src', t.data('original'));
    });
  };
  ...
  createPagination = function() {
    ...
    toggleFullscreen = function() {
      ...
      return window.readerSelect.trigger('change');
    };
