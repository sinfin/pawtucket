...
<div class="contribution">
	...
	<form method="post" enctype="multipart/form-data" action="<?php print caNavUrl($this->request, 'Splash', 'Submit', array()); ?>" name="contribution" class="form">
		...
		<div>
			<b><?php print _t("Describe in detail what you are interested in contributing to the Museum"); ?></b><br />
			<textarea name="what" rows="8" cols="73"></textarea>
		</div>
		<div>
			<b><?php print _t("Please fill in your name and email address so that we can get back to you."); ?></b><br />
			<textarea name="contact" rows="8" cols="73"></textarea>
		</div>
		<div>
			<b><?php print _t("If you have images of what you wish to contribute, please upload them here"); ?></b><br />
			<input type="file" name="images" id="file-field" />
			<br /><b><i><?php print _t("Only %1 allowed.", ".zip, .rar, .gz and .7z"); ?></i></b>
		</div>
		<div>
			<?php
		...
		<div>
			<a href="#" name="login" class="button" onclick="document.forms.contribution.submit(); return false;"><?php print _t("Submit"); ?></a>
		</div>
