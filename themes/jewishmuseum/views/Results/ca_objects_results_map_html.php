...
?>
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery('.searchNav', '.searchNavBg').html('<?php print _t("%1 of %2 results have been mapped. To see all results chose a different display.", $va_map_stats['items'], $vn_num_hits); ?>');
				});
			</script>
<?php
		} else {
?>
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery('.searchNav', '.searchNavBg').html('<?php print _t("Found %1 results.", $va_map_stats['items'])."</div>"; ?>');
				});
			</script>
<?php		
		}
		print "<div id=\"browse-map\">".$o_map->render('HTML', array('delimiter' => "<br/>"))."</div>";
	} else {
?>
	<div>
