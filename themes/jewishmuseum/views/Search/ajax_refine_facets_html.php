 ...
 */
	...
	$va_facets = $this->setVar('available_facets', $va_available_facets);
	$va_facet_info = $this->setVar('facet_info', $va_facet_info);
	$va_criteria = $this->setVar('criteria', $va_criteria);
